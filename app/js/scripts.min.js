...
nextArrow:'<div class="sl-post-arrow sl-post-right"><i class="fa fa-angle-right" aria-hidden="true"></i></div>',asNavFor:".sl-post-nav"}),$(".sl-post-nav").slick({slidesToShow:6,slidesToScroll:1,asNavFor:".sl-post",focusOnSelect:!0})});