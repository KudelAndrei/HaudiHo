...
nextArrow:'<div class="sl-post-arrow sl-post-right"><i class="fa fa-angle-right" aria-hidden="true"></i></div>',asNavFor:".sl-post-nav"}),$(".sl-post-nav").slick({slidesToShow:6,slidesToScroll:1,asNavFor:".sl-post",focusOnSelect:!0}),$(".sl-clients").slick({centerMode:!0,centerPadding:"60px",slidesToShow:1}),$(".sl-clients-nav").slick({slidesToShow:3,slidesToScroll:1,asNavFor:".sl-clients",focusOnSelect:!0})});